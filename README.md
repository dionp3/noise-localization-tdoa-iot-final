...
This project is a prototype system for detecting and determining the direction of a noise sound source using the Threshold Value and the Time Difference of Arrival (TDOA) method and Internet of Things (IoT) technology.
...
4. Azimuth angle and direction are estimated using atan2(x, y) trigonometric calculations.
